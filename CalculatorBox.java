...
public class CalculatorBox extends JFrame {
    ...
    JButton btnAdd, btnSubtract, btnDivide, btnMultiply, btnClear, btnDelete, btnEquals, btnDot, btnSpace;
    JButton numBtn[];
    JTextField output;
    ...
    public CalculatorBox() {
        ...
        btnEquals.setBackground(new Color(153,255,204));
        btnAdd.setFont(new Font("Monospaced", Font.BOLD, 22));
        btnAdd.setBackground(new Color(153,255,204));
        btnSubtract.setFont(new Font("Monospaced", Font.BOLD, 22));
        btnSubtract.setBackground(new Color(153,255,204));
        btnDivide.setFont(new Font("Monospaced", Font.BOLD, 22));
        btnDivide.setBackground(new Color(153,255,204));
        btnMultiply.setFont(new Font("Monospaced", Font.BOLD, 22));
        btnMultiply.setBackground(new Color(153,255,204));
        btnClear.setFont(new Font("Monospaced", Font.BOLD, 18));
        btnClear.setBackground(new Color(204,153,255));
        ...
        output.setDisabledTextColor(new Color(153, 255, 204));
        ...
        row1.add(btnClear);
        mainPanel.setBorder(BorderFactory.createEmptyBorder(10, 40, 10, 60));
        row1.add(btnDelete);
        row2.add(numBtn[7]);
        row2.add(numBtn[8]);
        row2.add(numBtn[9]);
